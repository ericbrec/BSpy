...
if __name__ == "__main__":
    ...
    if False:
        ...
        #sphere.add_boundary(Boundary(BSpline(Spline.sphere(1.0, 0.001)), Hyperplane.create_hypercube([1.0, 1.0], [0.0, 0.0])))
        #sphere.add_boundary(Boundary(BSpline(Spline.cone(2.0, 0.01, 3.0, 0.001) + (0.0, 0.0, -1.5)), Hyperplane.create_hypercube([1.0, 1.0], [0.0, 0.0])))
        ...
        halfSpace.add_boundary(Boundary(spline, Hyperplane.create_hypercube([6.0, 1.0], [-3.0, 0.0])))
    ...
    if True:
        ...
        paraboloid.add_boundary(Boundary(cap, Hyperplane.create_hypercube([2.0, 2.0], [-1.0, -1.0])))
        ...
        paraboloid2.add_boundary(Boundary(cap, Hyperplane.create_hypercube([2.0, 2.0], [-1.0, -1.0])))
