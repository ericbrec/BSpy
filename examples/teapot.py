...
if __name__=='__main__':
    ...
    for patch in teapotPatches:
        ...
        for i in range(4):
            for j in range(4):
                coefficients[j,i,0] = teapotVertices[patch[4*i + j] - 1][0] / 3.0
                coefficients[j,i,1] = -0.5 + 4.0 * teapotVertices[patch[4*i + j] - 1][2] / 9.0
                coefficients[j,i,2] = teapotVertices[patch[4*i + j] - 1][1] / 3.0
        app.AddSpline(DrawableSpline((4,4), (knots, knots), coefficients))
    app.mainloop()
